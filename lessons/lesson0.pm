...
<u>LAZY PEOPLE</u> : The code tags like <code>"click me"</code> are clikable, so you haven't to type every code snippets, risking a freaky typo... Just click on code tags to test it in the interpreter !
