...
You should see it as a good thing, because it allows variable interpolation into strings and helps the programmer know what kind of data they're dealing with...<br/><br/>
