...
The most common/simple variable is the <strong>scalar</strong> value and it's prefixed by a <strong>strikedtrhough S</strong>.<br/><br/>
Perl users call it <strong>sigil</strong> but normal people call it <strong>dollar</strong> (who say truth?).<br/>
